...
exports.runBaselineAnalysis = runBaselineAnalysis;
const rest_1 = require("@octokit/rest");
const google_genai_1 = require("@langchain/google-genai");
const groq_1 = require("@langchain/groq");
async function runBaselineAnalysis(repoUrl) {
...
Return ONLY valid JSON matching this structure:
{
  ...
  "documentation": { "score": number, "evidence": "string" }
    ...
    let responseText = '';
    try {
        const primaryLLM = new google_genai_1.ChatGoogleGenerativeAI({
        ...
        try {
            const fallbackLLM = new groq_1.ChatGroq({
    ...
    const totalScore = (parsed.codeQuality?.score || 0) +
